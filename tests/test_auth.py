...
class TestRegisterAPI:
    ...
    def test_register_invalid_types(self, client):
        """Test registration fails with invalid types"""
        data = {
...
class TestSigninAPI:
    ...
    def test_signin_invalid_types(self, client):
        """Test signin fails with invalid types"""
        data = {
